...
class StudentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'photo_family_book' => 'required|image',
            'photo_father_page' => 'required|image',
            'photo_mother_page' => 'required|image',
            'photo_child_page' => 'required|image',
            'photo_father_identity' => 'required|image',
            'photo_mother_identity' => 'required|image',
            'photo_vaccine_card' => 'required|image',
